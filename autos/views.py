...
#vamos a "hardcodear" el crud para make, y vamos a usar las clases
#que ya implementan estas funcionalidades, para entender ambos puntos de vistas.
#TODO: al termina la actividad, hay que ensuciarse las manos con algún método(por amor al arte
# usaría el largo, y para usar DRY usaría el de genéricos)
